...
As Hyperfy is in alpha, the scripting API is likely to evolve fast with breaking changes.  [This is from 2 Feb 25](https://github.com/hyperfy-xyz/hyperfy/tree/main/docs)
