...
Hyperfy is a digital space platform where anyone, without needing to be an expert in technology or 3D design, can create and explore immersive virtual worlds. Access it from your web browser on any device, including [virtual reality!](/guides/webxr/vr/)
...
- [Quickstart v2 Installation](/setup/quickstart/)  <Badge text="v2" variant="tip" />
