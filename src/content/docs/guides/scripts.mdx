...
As Hyperfy is in alpha, the scripting API is likely to evolve fast with breaking changes.  [This is from 2 Feb 25](https://github.com/wyattlovesgrapes/hyperfy/blob/docs-feb-2-25/docs/scripts.md)
