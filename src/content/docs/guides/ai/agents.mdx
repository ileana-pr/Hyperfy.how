...
### **Daydreams**
<Badge text="Blockchain" variant="note" />
...
Connect any [AI Agents to Solana](https://www.solanaagentkit.xyz/) Protocols

---

### Rig Onchain Kit
<Badge text="Blockchain" variant="note" />
[Rig Onchain Kit](https://0xplaygrounds.github.io/rig-onchain-kit/) is a robust framework for building AI-powered applications that interact natively with blockchain networks.


---

### Companion Intelligence
<Badge text="RAG" variant="note" /> <Badge text="Servers" variant="note" />

'[Companion Intelligence](https://www.companionintelligence.com/) is an integrated solution combines AI-ready servers, a Digital Memory platform, and personal AI agents to help you take control of your digital life.'
