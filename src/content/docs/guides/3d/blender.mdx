...
[Hyperfy theme for blender](https://github.com/HowieDuhzit/Hyperfy-Tools/blob/main/extras/Hyperfy.blend) and also default startup file for blender that includes the default terrain and hdr from hyperfy for the closest look to in world previewing
...
Add-on by [HowieDuhzit](/community/x/#howieduhzit)
...
* [Get Hyperfy Tools](https://extensions.blender.org/add-ons/hyperfy-tools/)
...
See also [Blender-Exporter](docs/blender-exporter)
