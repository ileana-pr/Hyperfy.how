...
'Self-hosting' means that you are in control of the server and need to get it started yourself.  For a more hands-off approach, and to have it hosted by others for a cost, check out [Hosting Providers](/hosting/providers/).


We will have more video guides soon.  These are some of the ways to do it.
...
[Install Hyperfy v2 via Quick Start](/setup/quickstart)
...
## Coolify Installation Guide: From Zero to Hyper Cool - [guide by Howie Duhzit]((https://github.com/howieduhzit))
